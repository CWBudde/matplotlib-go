#!/usr/bin/env python3
"""Matplotlib reference counterpart for examples/geo/mollweide.go.

The plot body lives in test/matplotlib_ref/plots/geo_mollweide_axes.py so reference
...
from test.matplotlib_ref.plots.geo_mollweide_axes import PLOT
