#!/usr/bin/env python3
"""Matplotlib reference counterpart for examples/gridspec/main.go.

The plot body lives in test/matplotlib_ref/plots/gridspec_composition.py so reference
...
from test.matplotlib_ref.plots.gridspec_composition import PLOT
