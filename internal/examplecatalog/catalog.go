...
var cases = []Case{
	...
	{ID: "fill_basic", Topic: "fill", Title: "Fill to Baseline", Showcase: true},
	...
	{ID: "boxplot_basic", Topic: "boxplot", Title: "Box Plot", Optional: true, Showcase: true},
	...
	{ID: "axes_control_surface", Topic: "axes", Title: "Axes, Scales, and Twins", Optional: true, WebDemoID: "axes", Description: "Minor ticks, top/right axes, aspect controls, log scale, twin axes, and secondary axes.", Showcase: true},
	{ID: "transform_coordinates", Topic: "axes", Title: "Transform Coordinates", Optional: true},
	{ID: "gridspec_composition", Topic: "composition", Title: "Figure Composition", WebDemoID: "composition", Description: "GridSpec spans, figure-level labels, figure legends, anchored text, and colorbars.", Showcase: true},
	{ID: "figure_labels_composition", Topic: "composition", Title: "Figure Labels", Showcase: true},
	{ID: "colorbar_composition", Topic: "colorbar", Title: "Colorbar Composition", Showcase: true},
	{ID: "annotation_composition", Topic: "annotation", Title: "Annotations", Showcase: true},
	{ID: "patch_showcase", Topic: "patches", Title: "Patch Showcase", Optional: true},
	{ID: "mesh_contour_tri", Topic: "mesh", Title: "Meshes and Contours", Optional: true, WebDemoID: "mesh", Description: "PColorMesh, contour/contourf, Hist2D, triplot, tripcolor, and tricontour.", Showcase: true},
	{ID: "plot_variants", Topic: "variants", Title: "Plot Variants", Optional: true, WebDemoID: "variants", Description: "Step, stairs, reference lines, spans, broken bars, and stacked bars.", Showcase: true},
	{ID: "spectrum_variants", Topic: "signal", Title: "Spectrum Variants", FixtureOnly: true},
	{ID: "stat_variants", Topic: "statistics", Title: "Statistical Views", Optional: true, WebDemoID: "statistics", Description: "Box plots, violin plots, empirical CDFs, and stack plots.", Showcase: true},
	...
	{ID: "units_overview", Topic: "units", Title: "Dates and Categories", Optional: true, WebDemoID: "units", Description: "Time-aware axes, categorical bars, and horizontal categorical bars.", Showcase: true},
	...
	{ID: "vector_fields", Topic: "vectors", Title: "Vector Fields", Optional: true, WebDemoID: "vectors", Description: "Quiver, quiver keys, barbs, streamplots, and grid-based vector input.", Showcase: true},
	{ID: "polar_axes", Topic: "polar", Title: "Polar Wave", WebDemoID: "polar", Description: "A filled polar curve with custom radial and angular grid styling.", Showcase: true},
	{ID: "geo_mollweide_axes", Topic: "geo", Title: "Projections and Insets", WebDemoID: "projections", Description: "Mollweide geo projection plus a zoomed inset axes.", Showcase: true},
	{ID: "geo_aitoff_axes", Topic: "geo", Title: "Aitoff Projection", Optional: true, Showcase: true},
	...
	{ID: "radar_basic", Topic: "radar", Title: "Radar Projection", Optional: true, Showcase: true},
	{ID: "skewt_basic", Topic: "skewt", Title: "Skew-T Projection", Optional: true, Showcase: true},
	{ID: "mplot3d_basic", Topic: "mplot3d", Title: "3D Toolkit Scaffold", Optional: true},
	{ID: "mplot3d_terrain", Topic: "mplot3d", Title: "3D Terrain", Optional: true, Width: 900, Height: 640, Showcase: true},
	...
	{ID: "unstructured_showcase", Topic: "unstructured", Title: "Unstructured Showcase", Optional: true, Showcase: true},
	{ID: "arrays_showcase", Topic: "arrays", Title: "Matrix Helpers", Optional: true, WebDemoID: "matrix", Description: "MatShow, sparsity spy plots, annotated heatmaps, and colorbars.", Width: 1240, Height: 620, Showcase: true},
	{ID: "axisartist_showcase", Topic: "axisartist", Title: "AxisArtist Showcase", Optional: true, Showcase: true},
	{ID: "axes_grid1_showcase", Topic: "axes_grid1", Title: "Axes Grid1 Showcase", Optional: true, Showcase: true},
