...
var cases = []Case{
	...
	{ID: "geo_aitoff_axes", Topic: "geo", Title: "Aitoff Projection", GoPath: "examples/geo/aitoff/main.go", PythonPath: "examples/geo/aitoff.py", Optional: true},
	{ID: "geo_hammer_axes", Topic: "geo", Title: "Hammer Projection", GoPath: "examples/geo/hammer/main.go", PythonPath: "examples/geo/hammer.py", Optional: true},
	{ID: "geo_lambert_axes", Topic: "geo", Title: "Lambert Projection", GoPath: "examples/geo/lambert/main.go", PythonPath: "examples/geo/lambert.py", Optional: true},
	{ID: "radar_basic", Topic: "radar", Title: "Radar Projection", GoPath: "examples/radar/basic.go", PythonPath: "examples/radar/basic.py", Optional: true},
	{ID: "skewt_basic", Topic: "skewt", Title: "Skew-T Projection", GoPath: "examples/skewt/basic.go", PythonPath: "examples/skewt/basic.py", Optional: true},
	{ID: "mplot3d_basic", Topic: "mplot3d", Title: "3D Toolkit Scaffold", GoPath: "examples/mplot3d/basic.go", PythonPath: "examples/mplot3d/basic.py", Optional: true},
	{ID: "mplot3d_terrain", Topic: "mplot3d", Title: "3D Terrain", GoPath: "examples/mplot3d/terrain/main.go", PythonPath: "examples/mplot3d/terrain/main.py", Optional: true, Width: 900, Height: 640},
